...
def generate_and_add_noise_cheques(num_cheques, folder_path, width=1000, height=500):
...
output_folder = r'/home/p3/Videos/bank-cheque-flipped'

# Generate cheques and add noise to 50 cheques with the same dimensions in the specified folder
generate_and_add_noise_cheques(50, output_folder)
