...
class ImagePreprocessor:
    ...
    def deskew(self, image):
        """
        Deskew the input image by correcting its angle of rotation.
        """
        try:
    ...
    def set_image_dpi(self, file_path):
        """
        Resize the image to a maximum width of 1024 pixels and set its DPI to 300.
        """
        try:
    ...
    def thin_image(self, image_path):
        """
        Apply the Zhang-Suen thinning algorithm to the image.
        """
        try:
    ...
    def preprocess_image(self, file_path):
        """
        Perform the full preprocessing pipeline on the input image.
        """
        try:
